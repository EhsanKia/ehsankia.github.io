...
function init() {
	...
	gRTCamera.position.set(1.5, -1.5, 2);
...
function setupGui() {
	...
	var cs = gui.add(gParams, "colorSteps", 0, 4).step(1);
	var ox1 = gui.add(gParams, "rotX1", 0.0, Math.PI);
	var oy1 = gui.add(gParams, "rotY1", 0.0, Math.PI);
	var oz1 = gui.add(gParams, "rotZ1", 0.0, Math.PI);
	var ox2 = gui.add(gParams, "rotX2", 0.0, Math.PI);
	var oy2 = gui.add(gParams, "rotY2", 0.0, Math.PI);
	var oz2 = gui.add(gParams, "rotZ2", 0.0, Math.PI);
...
$(document).ready(function() {
	$("#shader-fs").load("shaders/mandelbulb.fs", init);
});